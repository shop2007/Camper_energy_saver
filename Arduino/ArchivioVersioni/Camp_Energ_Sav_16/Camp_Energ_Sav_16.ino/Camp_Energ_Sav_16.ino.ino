String Versione = "Camp_Energ_Sav_16";
/*
...
void CalibrazioneSoglieKeyboard() {
  ...
  Serialprint2ln(F("Soglia BASSA: t/y/u (dim) - i/o/p (aum)"));
  Serialprint2ln(F("Soglia ALTA : f/g/h (dim) - j/k/l (aum)"));
  Serialprint2ln(F("Premi 'Q' per salvare e uscire."));

  //int Soglia_Bassa_Bit = 512;  // valore iniziale
  //int Soglia_Alta_Bit  = 512;

  float Soglia_Bassa_Volt;
  float Soglia_Alta_Volt;

  while (true) {
    // Lettura da seriale/bluetooth
    char c = 0;
    ...
    // Stampa
    Serialprint2(F("Soglia BASSA bit: "));
    Serialprint2(Soglia_Bassa_Bit);
    Serialprint2(F(" | Volt: "));
    Serialprint2(Soglia_Bassa_Volt, 3);
    Serialprint2(F(" T-100/Y-10/U-1 I+1/O+10/P+100   ||   "));
    
    Serialprint2(F("Soglia ALTA bit: "));
    Serialprint2(Soglia_Alta_Bit);
    Serialprint2(F(" | Volt: "));
    Serialprint2(Soglia_Alta_Volt, 3);
  ...
  Serialprint2ln(F("Soglie salvate in EEPROM."));
}
